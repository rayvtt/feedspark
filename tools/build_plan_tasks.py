...
def splice(out):
    ...
    for fn in ("FeedSpark_Command_Center.html","FeedSpark_Task_Library.html","FeedSpark_Readiness.html","FeedSpark_Leadership.html","FeedSpark_DeckBuilder.html","FeedSpark_Workflow.html","FeedSpark_Playbook.html"):
